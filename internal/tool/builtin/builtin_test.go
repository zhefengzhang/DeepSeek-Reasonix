...
func TestBuiltinsRegistered(t *testing.T) {
	want := []string{"bash", "code_index", "edit_file", "glob", "grep", "headroom_retrieve", "ls", "move_file", "multi_edit", "read_file", "understand_search", "web_fetch", "write_file"}
...
func TestBuiltinReadOnlyClassification(t *testing.T) {
	readOnly := map[string]bool{
		"read_file": true, "ls": true, "glob": true, "grep": true, "code_index": true, "understand_search": true, "web_fetch": true, "headroom_retrieve": true,
