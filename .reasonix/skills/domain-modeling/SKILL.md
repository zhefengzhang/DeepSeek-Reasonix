...
description: Build and sharpen a project's domain model. Use when the user wants to pin down domain terminology, resolve fuzzy language, or record an architectural decision. Invoked automatically when another skill updates CONTEXT.md or ADRs.
---
...
When a term is resolved, update `CONTEXT.md` right there. Do not batch these up — capture them as they happen. Use the format in `CONTEXT-FORMAT.md`.
