...
export const en = {
  ...
  "common.on": "On",
  "common.off": "Off",  "common.busyHint": "Finish or stop the current turn first",
  ...
  "composer.guidanceLabel": "Guidance prompt",
  "composer.guidanceHint": "Prepended to every message as <guidance>. Use it to enforce behaviour constraints.",
  "composer.guidancePlaceholder": "e.g. Execute each task step by step with tool calls. Verify before declaring completion.",
  ...
  "settings.planModeDefault": "Global plan mode",
  "settings.planModeDefaultHint": "New sessions start in plan mode. Use Shift+Ctrl+P to toggle per session.",
  ...
  "shortcuts.action.planModeToggle": "Toggle plan mode",
  ...
  "shortcuts.desc.planModeToggle": "Toggle plan mode to force step-by-step execution with read-only planning first.",
  ...
  "settings.headroomCompression": "Headroom compression",
  "settings.headroomActive": "Active",
  "settings.headroomPresetCode": "Code",
  "settings.headroomPreset": "Preset",
  ...
  "settings.headroomProtectErrors": "Protect error outputs",
