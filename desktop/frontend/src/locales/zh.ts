...
export const zh: Record<DictKey, string> = {
  ...
  "common.on": "开启",
  "common.off": "关闭",  "common.busyHint": "请先完成或停止当前回合",
  "common.loading": "加载中…",
  ...
  "composer.guidanceLabel": "约束提示词",
  "composer.guidanceHint": "每次发送消息时自动前置为 <guidance> 块。用于约束 AI 行为。",
  "composer.guidancePlaceholder": "例如：逐步执行每个任务，使用工具验证，完成后检查确认。",
  ...
  "settings.planModeDefault": "全局计划模式",
  "settings.planModeDefaultHint": "新会话默认进入计划模式。可使用 Shift+Ctrl+P 切换。",
  ...
  "shortcuts.action.planModeToggle": "切换计划模式",
  ...
  "shortcuts.desc.planModeToggle": "切换计划模式，强制 AI 先只读计划再逐步执行。",
  ...
  "settings.headroomCompression": "Headroom 压缩",
  "settings.headroomActive": "已启用",
  "settings.headroomPresetCode": "编程",
  "settings.headroomPreset": "预设",
  ...
  "settings.headroomProtectErrors": "保护错误输出",
